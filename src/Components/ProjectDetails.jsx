  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-royalblue font-medium">My Portfolio</span>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <p className="text-base md:text-lg text-mintgreen leading-relaxed">
            A modern personal portfolio website crafted to represent my journey
            as a Full Stack Developer. It showcases my projects, certifications,
            and skills with a responsive layout, smooth transitions, and elegant
            design principles.
          </p>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {["React", "Tailwind CSS", "Framer Motion", "Formspree"].map(
                (tech, index) => (
                  <span
                    key={index}
        ...
        >
          ...
          <div className="w-full p-6 bg-slate-700/20 backdrop-blur-md rounded-xl border border-white/10">
            ...
            <ul className="list-disc list-inside space-y-3 text-oceanblue text-sm md:text-base">
              <li>
                <strong>🧭 Smooth Navigation:</strong> Scroll-based single-page
                layout.
              </li>
              <li>
                <strong>🧾 Projects:</strong> Interactive cards with tech and
                feature details.
              </li>
              <li>
                <strong>📜 Certifications:</strong> Showcasing verified learning
                achievements.
              </li>
              <li>
              ...
              <li>
                <strong>📬 Contact Form:</strong> Email integration with
                Formspree.
              </li>
              <li>
                <strong>🌌 Theming:</strong> Consistent dark UI with cosmic
                palette.
              </li>
            </ul>
          </div>
